<html>
<head>
    <title>Bursary Applications By Date</title>
...
<hr>
<div class="heading">
    <h3 class="text-center">Bursary Applications By Date</h3>
</div>
<hr>
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4">
            <form action="bursary_applications_report_date.php" method="post">
