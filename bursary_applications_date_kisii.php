<html>
<head>
    <title>Bursary Applications By Date - Kisii County</title>
...
<hr>
<div class="heading">
    <h3 class="text-center">Bursary Applications By Date - Kisii County</h3>
</div>
<hr>
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4">
            <form action="bursary_applns_rep_date_kisii.php" method="post">
