<html>
<head>
    <title>Bursary Applications - Migori County</title>
...
<hr>
<div class="heading">
    <h3 class="text-center">Bursary Applications - Migori County</h3>
</div>
<hr>
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4">
            <form action="bursary_applications_report_migori.php" method="post">
