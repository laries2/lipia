...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2019 at 08:04 AM
...
CREATE TABLE `bursary_applicants` (
  ...
  `nok_tel_number` varchar(255) NOT NULL,
  ...
  `file_one` varchar(255) NOT NULL,
  `file_two` varchar(255) NOT NULL,
  `file_three` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `bursary_applicants` (`applicant_id`, `application_date`, `first_name`, `middle_name`, `last_name`, `gender`, `dob`, `tel_number`, `email_address`, `nok_name`, `nok_tel_number`, `nok_relationship`, `county`, `institution_name`, `fees_payable`, `fees_paid`, `balance`, `reasons`, `file_one`, `file_two`, `file_three`) VALUES
(1, '2019-07-25', 'Jackson', 'Mbuthia', 'Mwangi', 'Male', '1990-11-05', '0706814228', 'mwangize2018@gmail.com', 'qwrfweaf', '0706814228', 'Father', 'Siaya', 'eMobilis Mobile Technology Institute', 50000, 10500, 39500, 'dasdasdas asdf s af  f as fa sd f as d', 'sisi.jpg', 'LogoHD.pdf', 'LogoHD.jpg'),
(2, '2019-07-25', 'Emmanuel', 'Njenga', 'Gathu', 'Male', '1991-07-11', '07021431234', 'asfsdf@gmail.com', 'asfasdasd', '2342312321', 'Uncle', 'Migori', 'Dawamu Boys High School', 50000, 10500, 39500, 'Parent\'s low income.', 'Desert.jpg', 'Koala.jpg', '61580.pdf');
